...
# Linux命令 dos2unix - 将DOS格式文本文件转换成Unix格式

dos2unix将DOS格式文本文件转换成Unix格式补充说明dos2unix命令 用来将DOS格式的文本文件转换成UNIX格式的（DOS/MAC to UNIX text file format converter）。DOS下的文本文件是以\r\n作为断行标志的，表示成十六进制就是0D_来自Linux命令，w3cschool编程狮。
